...
public class FiltroPeriodoAgenda extends AppCompatActivity {

    static final int DATE_DIALOG_ID_Inicio = 999;
    static final int DATE_DIALOG_ID_Fim = 998;
    public String DataInicial, DataFinal, DTInicial, DTFinal, usuario, senha;
    Calendar calendar;
    ...
    private DatePickerDialog.OnDateSetListener datePickerListener = new DatePickerDialog.OnDateSetListener() {
        public void onDateSet(DatePicker view, int selectedYear, int selectedMonth, int selectedDay) {
            ...
            if (tag == DATE_DIALOG_ID_Inicio) {
                ...
                DTInicial = Util.AcrescentaZeros(String.valueOf(diaInicio), 2) + "/" + Util.AcrescentaZeros(String.valueOf(mesInicio + 1), 2) + "/" + anoInicio;
                dpResult.setText(DTInicial);
                DataInicial = Util.FormataDataAAAAMMDD_ComHoras(DTInicial+ " 00:00:00");
                ...
                DTFinal = Util.AcrescentaZeros(String.valueOf(diaFim), 2) + "/" + Util.AcrescentaZeros(String.valueOf((mesFim)), 2) + "/" + anoFim;
                dpResultFinal.setText(DTFinal);
                DataFinal = Util.FormataDataAAAAMMDD_ComHoras(DTFinal+ " 00:00:00");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.filtro_periodo_agenda);
        try {
        ...
        dpResultFinal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                datePickerDialog = new DatePickerDialog(FiltroPeriodoAgenda.this, datePickerListener, year, month, dayOfMonth);
    ...
    public void confirmafiltro(View view) {
        if (DataIni == null) {
            Util.msg_toast_personal(FiltroPeriodoAgenda.this, "Informar a data inicial!", Toast.LENGTH_SHORT);
            return;
        } else if (DataFim == null) {
            Util.msg_toast_personal(FiltroPeriodoAgenda.this, "Informar a data final", Toast.LENGTH_SHORT);
            return;
            ...
            Util.msg_toast_personal(FiltroPeriodoAgenda.this, getString(R.string.data_inicialfinal_invalida), Toast.LENGTH_SHORT);
        }
