...
/*
    ...
    public Cursor buscar_produtos(int Param) {
        ...
        try {
            if (Param == 1) {
                cursor = db.rawQuery("select CODITEMANUAL as _id, CODITEMANUAL, DESCRICAO, UNIVENDA, VENDAPADRAO, VLVENDA1,VLVENDA2,VLVENDA3,VLVENDA4,VLVENDA5, VLVENDAP1,VLVENDAP2,QTDESTPROD, CLASSE, " +
