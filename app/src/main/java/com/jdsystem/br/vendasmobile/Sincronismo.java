                    ...
                    try {
                        ...
                        try {
                            for (int co = 0; co < Cont.length(); co++) {
                                JSONObject cc = Cont.getJSONObject(co);
                                if (co == 0) {
                                    NomeContato = cc.getString("nome").replace("'", "''");
                                    CargoContato = cc.getString("cargo").replace("'", "''");
                                    EmailContato = cc.getString("email");
            ...
            for (int k = 0; k < ProdItens.length(); k++) {
                while (jumpTime < totalProgressTime) {
                    try {
                        ...
                        String Ativo = CItens.getString(TAG_ATIVO);
                        int item = CItens.getInt(TAG_CODIGOITEM);
                        ...
                        /*if(item == 3049){
                            teste = CItens.getString(TAG_DESCRICAO).replace("'","''");
                        }*/
                        ...
                        try {
                            ...
                            E.toString();
                            //sincprodstatic = "Falha no insert ou update do SQL (CursItens) no Sincronismo";
                            //return sincprodstatic;
                        }

                    } catch (Exception E) {
                        E.toString();
                        //sincprodstatic = "Falha no JSONObject do Sincronismo";
                        //return sincprodstatic;
                    }
                }
