...
public class ListAdapterClientesPedido extends RecyclerView.Adapter<ListAdapterClientesPedido.MyViewHolder> {
    private List<ClientesPedido> mList;
    private LayoutInflater mLayoutInflater;
    private RecyclerViewOnClickListenerHack mRecyclerViewOnClickListenerHack;


    public ListAdapterClientesPedido(Context c, List<ClientesPedido> l) {
        mList = l;
    ...
    public void addListItem(ClientesPedido c, int position) {
        mList.add(c);
