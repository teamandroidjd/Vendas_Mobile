...
public class ListAdapterFiltroContatos extends RecyclerView.Adapter<ListAdapterFiltroContatos.MyViewHolder> {
    private List<FiltroContatos> mList;
    private LayoutInflater mLayoutInflater;
    private RecyclerViewOnClickListenerHack mRecyclerViewOnClickListenerHack;


    public ListAdapterFiltroContatos(Context c, List<FiltroContatos> l) {
        mList = l;
    ...
    public void addListItem(FiltroContatos c, int position) {
        mList.add(c);
